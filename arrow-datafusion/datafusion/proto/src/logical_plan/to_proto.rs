...
use datafusion_expr::expr::{
    self, Between, BinaryExpr, Cast, GetIndexedField, GroupingSet, Like, Sort, BooleanQuery,
};
use datafusion_expr::{
    ...
    fn try_from(expr: &Expr) -> Result<Self, Self::Error> {
        ...
        let expr_node = match expr {
            ...
            Expr::BooleanQuery(BooleanQuery { .. }) => {
                // Try to linerize a nested boolean query tree of the same operator
                // into a flat vector of expressions.   
                unimplemented!("BooleanQuery in proto isn't implemented.")
            }
